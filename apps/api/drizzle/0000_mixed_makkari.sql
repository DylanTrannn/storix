...
CREATE UNIQUE INDEX "cart_items_cart_variant_unique_idx" ON "cart_items" USING btree ("cart_id","variant_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "wishlist_items_user_product_unique_idx" ON "wishlist_items" USING btree ("user_id","product_id");